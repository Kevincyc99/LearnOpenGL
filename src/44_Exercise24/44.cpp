...
int main()
{
    ...
    //----------------------------------------------------------------
    //加载着色器
    Shader lightingShader("./src/44_Exercise24/Shader/lightVertex.glsl", "./src/44_Exercise24/Shader/lightFragment.glsl");
    Shader lightCubeShader("./src/44_Exercise24/Shader/cubeVertex.glsl", "./src/44_Exercise24/Shader/cubeFragment.glsl");
    //开启深度测试
