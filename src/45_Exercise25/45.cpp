...
int main()
{
    ...
    //----------------------------------------------------------------
    //加载着色器
    Shader lightingShader("./src/45_Exercise25/Shader/lightVertex.glsl", "./src/45_Exercise25/Shader/lightFragment.glsl");
    Shader lightCubeShader("./src/45_Exercise25/Shader/cubeVertex.glsl", "./src/45_Exercise25/Shader/cubeFragment.glsl");
    //开启深度测试
    ...
    float ambientStrength = 0.2f;   //环境因子
    float diffuseStrength = 0.5f;  //镜面强度
    float specularStrength = 1.0f;   //环境因子
    //----------------------------------------------------------------
    //渲染循环
	while(!glfwWindowShouldClose(window))
	{
        ...
        ImGui::SliderFloat("Diffuse Factor", &diffuseStrength, 0.0, 1.0f);
        ...
        lightingShader.setVec3("light.diffuse",  diffuseStrength, diffuseStrength, diffuseStrength);
