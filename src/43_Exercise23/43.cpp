...
int main()
{
    ...
    //----------------------------------------------------------------
    //加载着色器
    Shader lightingShader("./src/43_Exercise23/Shader/lightVertex.glsl", "./src/43_Exercise23/Shader/lightFragment.glsl");
    Shader lightCubeShader("./src/43_Exercise23/Shader/cubeVertex.glsl", "./src/43_Exercise23/Shader/cubeFragment.glsl");
    //开启深度测试
