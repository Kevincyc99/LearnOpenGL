...
int main()
{
    ...
    //----------------------------------------------------------------
    //加载着色器
    Shader lightingShader("./src/41_Exercise22/Shader/lightVertex.glsl", "./src/41_Exercise22/Shader/lightFragment.glsl");
    Shader lightCubeShader("./src/41_Exercise22/Shader/cubeVertex.glsl", "./src/41_Exercise22/Shader/cubeFragment.glsl");
    //开启深度测试
