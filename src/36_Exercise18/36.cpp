...
int main()
{
    ...
    //----------------------------------------------------------------
    //加载着色器
    Shader lightingShader("./src/36_Exercise18/Shader/lightVertex.glsl", "./src/36_Exercise18/Shader/lightFragment.glsl");
    Shader lightCubeShader("./src/36_Exercise18/Shader/cubeVertex.glsl", "./src/36_Exercise18/Shader/cubeFragment.glsl");
    //开启深度测试
