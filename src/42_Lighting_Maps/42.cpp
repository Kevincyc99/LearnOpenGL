...
int main()
{
    ...
    //----------------------------------------------------------------
    //加载着色器
    Shader lightingShader("./src/42_Lighting_Maps/Shader/lightVertex.glsl", "./src/42_Lighting_Maps/Shader/lightFragment.glsl");
    Shader lightCubeShader("./src/42_Lighting_Maps/Shader/cubeVertex.glsl", "./src/42_Lighting_Maps/Shader/cubeFragment.glsl");
    //开启深度测试
