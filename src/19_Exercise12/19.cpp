...
int main()
{
    ...
    Shader ourShader("./src/19_Exercise12/Shader/vertex.glsl", "./src/19_Exercise12/Shader/fragment.glsl");
	...
	while(!glfwWindowShouldClose(window))
	{
        ...
        trans = glm::rotate(trans, glm::radians(factor * 25.0f), glm::vec3(0, 0, 1.0f));
        ...
        trans = glm::scale(trans, glm::vec3(abs(sin(factor)), abs(sin(factor)), 0.5f));
        glUniformMatrix4fv(transformLoc, 1, GL_FALSE, glm::value_ptr(trans));
        trans = glm::mat4(1.0f);
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);
