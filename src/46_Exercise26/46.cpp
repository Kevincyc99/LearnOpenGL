...
int main()
{
    ...
    //----------------------------------------------------------------
    //加载着色器
    Shader lightingShader("./src/46_Exercise26/Shader/lightVertex.glsl", "./src/46_Exercise26/Shader/lightFragment.glsl");
    Shader lightCubeShader("./src/46_Exercise26/Shader/cubeVertex.glsl", "./src/46_Exercise26/Shader/cubeFragment.glsl");
    //开启深度测试
