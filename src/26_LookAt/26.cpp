...
int main()
{
    ...
    //----------------------------------------------------------------
    //加载着色器
    Shader ourShader("./src/26_LookAt/Shader/vertex.glsl", "./src/26_LookAt/Shader/fragment.glsl");
	...
	while(!glfwWindowShouldClose(window))
	{
        ...
        view = glm::lookAt(glm::vec3(camX, 0.0f, camZ), glm::vec3(cubePositions[0]), cameraUp);
        //投影矩阵
